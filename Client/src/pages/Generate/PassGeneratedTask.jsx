    ...
    return (
        <div className={className}>
            ...
            <div className='flex justify-around mb-4'>
                <kbd className="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-green-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">+</kbd>
                <kbd className="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-red-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">-</kbd>
                <kbd className="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-yellow-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">OT</kbd>
                <kbd className="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-white border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">P</kbd>
            </div>
